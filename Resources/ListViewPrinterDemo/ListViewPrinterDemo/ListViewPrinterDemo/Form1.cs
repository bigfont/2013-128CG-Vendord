...
namespace ListViewPrinterDemo
{
    public partial class Form1 : Form
    {
        ...
        public void ApplyMinimalFormatting()
        {
            ...
            this.listViewPrinter1.HeaderFormat.SetBorderPen(BrightIdeasSoftware.Sides.Bottom, new Pen(Color.Black, 0.5f));
            ...
            this.listViewPrinter1.GroupHeaderFormat.SetBorder(BrightIdeasSoftware.Sides.Bottom, 2, brush);
        ...
        public void ApplyModernFormatting()
        {
            ...
            this.listViewPrinter1.HeaderFormat = BrightIdeasSoftware.BlockFormat.Header(new Font("Verdana", 24, FontStyle.Bold));
            ...
            this.listViewPrinter1.GroupHeaderFormat = BrightIdeasSoftware.BlockFormat.GroupHeader();
            this.listViewPrinter1.ListHeaderFormat = BrightIdeasSoftware.BlockFormat.ListHeader(new Font("Verdana", 12));
        ...
        public void ApplyOverTheTopFormatting()
        {
            ...
            this.listViewPrinter1.HeaderFormat = BrightIdeasSoftware.BlockFormat.Header(new Font("Comic Sans MS", 36));
            ...
            this.listViewPrinter1.HeaderFormat.SetBorder(BrightIdeasSoftware.Sides.All, 10, new LinearGradientBrush(new Point(0, 0), new Point(300, 0), Color.Purple, Color.Pink));

            this.listViewPrinter1.FooterFormat = BrightIdeasSoftware.BlockFormat.Footer(new Font("Comic Sans MS", 12));
            ...
            this.listViewPrinter1.FooterFormat.SetBorderPen(BrightIdeasSoftware.Sides.All, new Pen(Color.FromArgb(128, Color.Green), 5));

            this.listViewPrinter1.GroupHeaderFormat = BrightIdeasSoftware.BlockFormat.GroupHeader();
            Brush brush = new HatchBrush(HatchStyle.LargeConfetti, Color.Blue, Color.Empty);
            this.listViewPrinter1.GroupHeaderFormat.SetBorder(BrightIdeasSoftware.Sides.Bottom, 5, brush);

            this.listViewPrinter1.ListHeaderFormat = BrightIdeasSoftware.BlockFormat.ListHeader(new Font("Comic Sans MS", 12));
